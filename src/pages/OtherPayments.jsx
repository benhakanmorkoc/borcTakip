...
export default function OtherPayments() {
  ...
  const handleSubmit = (e) => {
    ...
    if (editing) updateOtherPayment(editing, payload)
    else addOtherPayment(payload)
    setOpen(false)
  }
      ...
      {isProjected && (
        <div className="flex items-start gap-2 rounded-xl border border-blue-100 bg-blue-50 px-3 py-2 text-[11px] text-blue-800">
          ...
          <p>
            ...
            işaretleri kapalı. Bu ay geldiğinde gerçek tutarları girip güncelleyebilirsiniz.
          </p>
        </div>
      )}
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex gap-1">
                      ...
                      {!projected && (
                        <button
                          type="button"
                          onClick={() => removeOtherPayment(item.id)}
